...
public class DrawTextMethod implements ModuleMethodExecutable<Object> {
    ...
    public String[] getParameterNames() {
        return new String[]{"renderBinding", "text", "x", "y", "font", "fontSize", "color"};
    }
    ...
    public Object onFunctionEnd(int line, ComputerCallback computer, Map<String, Variable> parameters, Object onFunctionStartResult) throws ExecutionException {
        ...
        String color = GraphicsRenderBindingValidator.validatePaint(line, parameters, "color", "drawText");

        List<String> existingData = renderCommandSink.getExistingData();

        List<String> newData = new ArrayList<>(existingData);
        newData.add("text:"+x+":"+y+":"+color+":"+font+":"+fontSize+":"+text);
